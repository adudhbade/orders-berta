...
func TestMemoryGetByNamespaceSuccess(t *testing.T) {
	...
	//when
	orderN7 := Order{OrderId: "orderId1", Namespace: "N7", Total: 10, PostalCode: "80636", Town: "Munich", UserId: "mori@hybris.com", ProductName: "Camera"}
	orderN8 := Order{OrderId: "orderId1", Namespace: "N8", Total: 10, PostalCode: "80636", Town: "Munich", UserId: "mori@hybris.com", ProductName: "Camera"}
...
func TestMemoryDeleteSuccess(t *testing.T) {
	...
	err := repo.InsertOrder(Order{OrderId: "orderId1", Namespace: "N7", Total: 10, PostalCode: "80636", Town: "Munich", UserId: "mori@hybris.com", ProductName: "Camera"})
	assert.NoError(t, err)
