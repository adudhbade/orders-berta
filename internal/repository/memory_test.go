...
func TestMemoryCreateAndGet(t *testing.T) {
	...
	//when
	newOrder := Order{OrderId: "orderId1", Namespace: "N7", Total: 10, PostalCode: "80636", Town: "Munich", UserId: "morihybris.com", ProductName: "Camera"}
	...
	assert.Equal(t, resultOrders[0].UserId, "morihybris.com")
...
func TestMemoryGetByNamespaceSuccess(t *testing.T) {
	...
	//when
	orderN7 := Order{OrderId: "orderId1", Namespace: "N7", Total: 10, PostalCode: "80636", Town: "Munich", UserId: "morihybris.com", ProductName: "Camera"}
	orderN8 := Order{OrderId: "orderId1", Namespace: "N8", Total: 10, PostalCode: "80636", Town: "Munich", UserId: "morihybris.com", ProductName: "Camera"}
...
func TestMemoryDeleteSuccess(t *testing.T) {
	...
	err := repo.InsertOrder(Order{OrderId: "orderId1", Namespace: "N7", Total: 10, PostalCode: "80636", Town: "Munich", UserId: "morihybris.com", ProductName: "Camera"})
	assert.NoError(t, err)
