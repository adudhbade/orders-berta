...
func TestCreateOrderSuccess(t *testing.T) {
	...
	newOrder := repository.Order{OrderId: "orderId1", Namespace: "N7", Total: 10, PostalCode: "80636", Town: "Munich", UserId: "morihybriscom", ProductName: "Camera"}
...
func TestCreateOrderWithoutNamespaceSuccess(t *testing.T) {
	...
	newOrder := repository.Order{OrderId: "orderId1", Total: 10, PostalCode: "80636", Town: "Munich", UserId: "morihybriscom", ProductName: "Camera"}

	// repository gets an order with default namespace (handler adds it)
	expectedOrder := repository.Order{OrderId: "orderId1", Namespace: "default", Total: 10, PostalCode: "80636", Town: "Munich", UserId: "morihybriscom", ProductName: "Camera"}
